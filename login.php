...
//     // Lưu user_id và tên người dùng vào session
    ...
    <style>
        ...
        * {
        ...
        .container {
            background: #fff;
            border-radius: 10px;
            box-shadow: 0 14px 28px rgba(255, 158, 0, 0.9), 0 10px 10px rgba(255, 158, 0, 0.9);
            position: relative;
            overflow: hidden;
            width: 768px;
            max-width: 100%;
        ...
        .overlay {
            background: #f5a06b;
            background: linear-gradient(to right, #f5a06b, #f5a06b) no-repeat 0 0 / cover;
            color: #fff;
            position: relative;
            left: -100%;
            height: 100%;
    ...
    <div class="container" id="container">
        <div class="form-container sign-up-container">
            <form action="register.php" method="post">
                ...
                <span>Hoặc dử dụng email của bạn để đăng ký</span>
        ...
        <div class="overlay-container">
            <div class="overlay">
                ...
                <div class="overlay-panel overlay-right">
                    <h1>Chào bạn!</h1>
                    <p>Nhập thông tin cá nhân của bạn và bắt đầu đồng hành cùng chúng tôi</p>
